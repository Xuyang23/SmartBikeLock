...
{   
    ...
    saraSerial.begin(9600, SWSERIAL_8N1, D11, D10, false);
    saraSerial.end();
    ...
    {
      Serial.print(F("The SARA is not yet connected to an operator. Please use the previous examples to connect. Retrying..."));
      return SARA5_ERROR_ERROR;
    }
